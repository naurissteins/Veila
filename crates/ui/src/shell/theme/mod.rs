...
pub struct ShellTheme {
    ...
    pub status_pending_opacity: Option<u8>,
    pub status_rejected_color: Option<ClearColor>,
    pub status_rejected_opacity: Option<u8>,
    pub caps_lock_color: Option<ClearColor>,
    pub caps_lock_opacity: Option<u8>,
...
impl ShellTheme {
    pub fn from_config(config: &AppConfig) -> Self {
        Self {
            ...
            reveal_opacity: config.visuals.reveal_opacity(),
            ...
            status_pending_opacity: config.visuals.status_pending_opacity(),
            status_rejected_color: config.visuals.status_rejected_color().map(to_color),
            status_rejected_opacity: config.visuals.status_rejected_opacity(),
            caps_lock_color: config.visuals.caps_lock_color().map(to_color),
            caps_lock_opacity: config.visuals.caps_lock_opacity(),
